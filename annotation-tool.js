...
// ***** BUG FIX IS IN THIS FUNCTION *****
function showTextInput(x, y) {
    textInputBox.style.display = "block";
    textInputBox.value = "";
    // CORRECTED: Changed textInput-box to textInputBox
    textInputBox.style.left = `${x + canvas.offsetLeft}px`;
    textInputBox.style.top = `${y + canvas.offsetTop}px`;
